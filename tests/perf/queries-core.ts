/**
 * Core query set for regular performance testing
 *
 * This is a curated subset of queries that cover the most important
 * search patterns while keeping test time reasonable.
 *
 * For full query coverage, use queries-full.ts
 */
export const queriesCore = [
  {
...
/**
 * Extended query set for comprehensive testing
 *
 * Use this for occasional deep testing or when investigating
...
export const queries = queriesCore;
